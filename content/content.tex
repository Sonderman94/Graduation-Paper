...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=1.0\textwidth]{项目依赖伪代码.png}
    \caption{POM依赖管理}
    \label{POM依赖管理}
\end{figure}
...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=0.2\textwidth]{Register流程图.png}
    \caption{用户注册流程图}
    \label{用户注册流程图}
\end{figure}
...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=0.3\textwidth]{login流程图.png}
    \caption{用户登录流程图}
    \label{用户登录流程图}
\end{figure}
...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=0.15\textwidth]{uploadVideo流程图.png}
    \caption{视频上传流程图}
    \label{视频上传流程图}
\end{figure}
...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=0.2\textwidth]{getVideoById.png}
    \caption{视频播放流程图}
    \label{视频播放流程图}
\end{figure}
...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=0.15\textwidth]{sendDanmu流程图.png}
    \caption{弹幕发送流程图}
    \label{弹幕发送流程图}
\end{figure}
...
弹幕列表获取功能，当需要获取某个视频的弹幕列表时，系统会调用getDanmuList方法，流程图\ref{弹幕列表获取流程图}如图，具体处理如下：

\begin{figure}[hbt]
    \centering
    \includegraphics[width=0.15\textwidth]{getDanmuList流程图.png}
    \caption{弹幕列表获取流程图}
    \label{弹幕列表获取流程图}
\end{figure}
...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=0.15\textwidth]{searchVideos流程图.png}
    \caption{视频搜索流程图}
    \label{视频搜索流程图}
\end{figure}
...
视频索引创建功能，当需要为新视频创建索引时，系统会调用createVideoIndex方法，流程图\ref{视频索引创建流程图}如图，具体步骤如下：

\begin{figure}[hbt]
    \centering
    \includegraphics[width=0.15\textwidth]{createVideoIndex流程图.png}
    \caption{视频索引创建流程图}
    \label{视频索引创建流程图}
\end{figure}
